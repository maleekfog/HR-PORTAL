    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
        <div className="order-2 md:order-1">
          <span className="text-blue-500 font-bold uppercase tracking-[0.4em] text-[10px] mb-6 block">The House of FOG</span>
          <h1 className="text-6xl md:text-8xl font-black mb-8 leading-[0.9] tracking-tighter uppercase text-white">STREET <br />SOUL. <br /><span className="italic text-blue-500">LUXURY</span> HEART.</h1>
          ...
          <div className="grid grid-cols-2 gap-12 border-t border-white/10 pt-10">
            ...
            <div>
              <div className="text-5xl font-bold text-blue-500 mb-2 tracking-tighter">VI</div>
        ...
        <div className="order-1 md:order-2 relative">
          ...
          <img 
            ...
            className="relative rounded-[2rem] border border-white/10 grayscale hover:grayscale-0 transition-all duration-1000 object-cover aspect-[4/5] shadow-2xl"
          />
        </div>
      </div>
      ...
      <section className="mb-32">
        <h2 className="text-4xl font-black mb-20 text-center tracking-tighter uppercase text-white">The <span className="text-blue-500 italic">Original</span> Benefits</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="glass p-10 group hover:border-blue-500/20 transition-all rounded-[2rem]">
              <h4 className="text-xl font-bold mb-4 uppercase tracking-tight group-hover:text-blue-400 transition-colors text-white">{perk.title}</h4>
      ...
      {/* Manifesto */}
      <div className="bg-white text-black rounded-[4rem] p-12 md:p-32 text-center shadow-2xl">
        ...
        <p className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-16 leading-none">
          "WE DON'T FOLLOW <br /> TRENDS. WE ARE THE <br /> <span className="text-blue-600">DIRECTION</span>."
        </p>
        <div className="h-20 w-px bg-blue-600 mx-auto"></div>
      </div>
    </div>
  );
};
